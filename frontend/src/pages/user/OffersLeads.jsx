  ...
  const searchAdmitadProducts = async () => {
    ...
    try {
      ...
      const res = await api.get(
        `/affiliate/admitad/search?q=${encodeURIComponent(searchQuery.trim())}`,
      );
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-dark-400 mt-1">
              Browse affiliate offers and track your leads
            </p>
          </div>
                ...
                <div className="flex gap-4 items-center flex-wrap">
                  <div className="flex items-center gap-2 flex-1 min-w-[300px]">
                    ...
                    <input
                      ...
                      onKeyDown={(e) =>
                        e.key === "Enter" && searchAdmitadProducts()
                      }
                      placeholder="Search Admitad products (e.g., wear, electronics)..."
                      className="input flex-1"
                    />
                    <Button
                      onClick={searchAdmitadProducts}
                      ...
                      >
                        ...
                        <CardContent className="p-4">
                          ...
                          <div className="flex gap-2">
                            <Button
                              onClick={() =>
                                window.open(`/click/${product.id}`, "_blank")
                              }
                              className="flex-1"
                            >
            ...
            {loading ? (
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-dark-400">
                    Check back later for new affiliate offers
                  </p>
                </CardContent>
              </Card>
            ) : (
                ...
                {offers.map((offer) => (
                  <Card key={offer.id} className="overflow-hidden">
                    ...
                    <CardContent className="p-4">
                      ...
                      <p className="text-dark-400 text-sm mb-3 line-clamp-2">
                        {offer.description ||
                          offer.ai_generated_ad ||
                          "High-quality affiliate product"}
                      </p>
                      ...
                      <div className="flex gap-2">
                        ...
                        {offer.affiliate_link && (
                          <Button
                            variant="outline"
                            onClick={() =>
                              copyAffiliateLink(offer.affiliate_link)
                            }
                          >
                            <Copy className="w-4 h-4" />
                          </Button>
            ...
            <CardContent>
              {leads.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-dark-400">
                    No clicks tracked yet. Start promoting offers!
                  </p>
                </div>
              ) : (
